...
firebase = firebase.FirebaseApplication('https://criminal-identification-faf28-default-rtdb.firebaseio.com/', None)
window = tk.Tk()
...
message = tk.Label(window, text="AUTOMATED CRIMINAL IDENTIFICATION SYSTEM" ,bg="#496E7C"  ,fg="white"  ,width=50  ,height=2,font=('times', 30, 'bold')) 
...
lbl3 = tk.Label(window, text="Criminal_Reports",width=15  ,fg="white"  ,bg="#496E7C"  ,height=2 ,font=('times', 15, ' bold')) 
...
def TrackImages():
    ...
    fileName="Criminal_Reports\criminals_"+date+"_"+Hour+"-"+Minute+"-"+Second+".csv"
